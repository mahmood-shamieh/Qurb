...
class _RequirementScreenState extends State<RequirementScreen> {
  ...
  void dispose() {
    ...
    Get.delete<RequrementScreenGetXController>();
    super.dispose();
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RequrementScreenGetXController>(
        init: Get.put(RequrementScreenGetXController()),
        builder: (controller) {
          // print('build');
