...
class RequrementScreenGetXController extends GetxController {
  // @override
  // void onReady() {
  ...
  Future<void> getQustions() async {
    // print('getQustions() called');
    isLoading.value = true;
    update();
    ResponseModel responseModel = await GetQuestionsApi().callAPI(user: {
  ...
  void submitAnswer() async {
    ...
    ResponseModel responseModel = await SubmitAnswerApi().callAPI(user: user);
